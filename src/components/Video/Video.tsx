...
export const Video = ({ endLoad }: Props): JSX.Element => {
  ...
  const [src, setSrc] = useState("https://www.youtube.com/embed/IELHelXHBSQ?autoplay=1&loop=1&playlist=IELHelXHBSQ")
  ...
  const onPlay = () => {
    setOpen(true)
    setSrc("https://www.youtube.com/embed/IELHelXHBSQ?autoplay=1&loop=1&playlist=IELHelXHBSQ")
  }
